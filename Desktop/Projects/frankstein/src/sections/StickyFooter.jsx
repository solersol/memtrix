...
import {img1, img2, cardImage1} from '../assets/images'; // Update with your image path

const StickyFooter = () => {
  return (
    <footer className="fixed bottom-0 left-0 right-0  py-4 flex flex-col items-center justify-center z-50">
      <div className=" flex justify-center space-x-4 mb-4">
        <a href="https://x.com/InfluencerMeme">
        ...
        <a href="https://t.me/GrandpasClub">
          <img src={cardImage1} alt="Image 3" className="w-16 h-16 sm:w-12 sm:h-12 transition-transform transform hover:scale-125" />
        </a>
      </div>
